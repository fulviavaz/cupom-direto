...
import { Calendar, Ticket, Gift, CheckCircle2 } from 'lucide-react'
          ...
          >
            <div className="grid items-center gap-4 md:grid-cols-[110px_1fr_auto_92px]">
              ...
              <div className="min-w-0">
                <h3 className="truncate text-[22px] font-title uppercase tracking-wide text-[#111]">
                  {coupon.title}
                </h3>

                <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-[11px] font-bold text-[#666]">
                  ...
                  <span className="flex items-center gap-1">
                    ...
                    {coupon.usesCount || '0'} cupons disponíveis
                  </span>
                  <span className="flex items-center gap-1">
                    <Gift className="h-3.5 w-3.5" strokeWidth={2.5} />
                    Cupom {getCouponTypeLabel(coupon.couponType)}
                  </span>
                  {coupon.isVerified && (
                    <span className="flex items-center gap-1 text-[#06b6b2]">
              ...
              <div className="text-left md:text-right flex flex-col justify-center h-full">
                <p className="text-[32px] font-title leading-none text-[#111] md:text-[42px]">
                  {coupon.discountValue !== null ? `${coupon.discountValue}%` : '—'}
                </p>
                <p className="font-title text-[14px] uppercase tracking-wide leading-none text-[#111]">
                  de desconto
                </p>
              </div>
            </div>
          ...
          <div className="w-full max-w-[520px] rounded-[20px] bg-white p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <h3 className="mt-1 text-[32px] font-title uppercase leading-tight text-[#111]">
            ...
            {selectedCoupon.code ? (
              <div className="mt-6 rounded-[16px] border border-dashed border-[#d7d7d7] bg-[#fafafa] p-5 text-center">
                <p className="text-[14px] font-title uppercase tracking-wider text-[#777]">
                  Código do cupom
                </p>
                <p className="mt-2 text-[36px] font-title uppercase text-[#111]">
                  {selectedCoupon.code}
                </p>
              </div>
            ) : (
